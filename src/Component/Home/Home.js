      ...
      <div className="deal-row">
        ...
        <Slider {...settings}>
          <Card
            ...
            onClick={() =>
              handleCardClick({
                ...
                price: "$15.99",
                originalPrice: "$19.99",
                description: "Special discount on bulk purchase.",
              })
            }
          />
          <Card
          ...
          <Card
            ...
            onClick={() =>
              handleCardClick({
                title: "Samsung S8+ Phone",
                images: [phone],
                price: "$299.99",
                originalPrice: "$499.99",
                description: "Clearance sale, while stocks last.",
              })
            }
          />
        </Slider>
          ...
          <Card
            ...
            onClick={() =>
              handleCardClick({
                ...
                price: "$7.99",
                originalPrice: "$9.99",
                description: "Rich color, smooth application.",
              })
            }
          />
          <Card
          ...
          <Card
            ...
            onClick={() =>
              handleCardClick({
                ...
                price: "$299.99",
                originalPrice: "$599.99",
                description: "Special clearance event pricing.",
              })
            }
          />
          <Card
            ...
            onClick={() =>
              handleCardClick({
                ...
                price: "$19.99",
                originalPrice: "$39.99",
                description: "20 lbs bag of premium dog food.",
              })
            }
          />
          <Card
            ...
            onClick={() =>
              handleCardClick({
                ...
                price: "$0.99",
                originalPrice: "$1.99",
                description: "Fresh organic limes on sale.",
              })
            }
          />
          <Card
            ...
            onClick={() =>
              handleCardClick({
                ...
                price: "$999.99",
                originalPrice: "$1299.99",
                description: "Lightweight, powerful and affordable.",
              })
            }
          />
        </Slider>
          ...
          <Card
            ...
            onClick={() =>
              handleCardClick({
                ...
                price: "$0.99",
                originalPrice: "$1.49",
                description: "Organically grown fresh broccoli.",
              })
            }
          />
          <Card
            ...
            onClick={() =>
              handleCardClick({
                ...
                price: "$2.99",
                originalPrice: "$3.99",
                description: "Classic Heinz ketchup.",
              })
            }
          />
          <Card
            ...
            onClick={() =>
              handleCardClick({
                ...
                price: "$1.99",
                originalPrice: "$2.99",
                description: "Healthy margarine alternative.",
              })
            }
          />
        </Slider>
